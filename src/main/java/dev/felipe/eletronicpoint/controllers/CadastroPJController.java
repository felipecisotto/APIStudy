package dev.felipe.eletronicpoint.controllers;
...
import dev.felipe.eletronicpoint.dto.CadastroPJDto;
...
import dev.felipe.eletronicpoint.response.Response;
...
public class CadastroPJController {
	...
	public ResponseEntity<Response<CadastroPJDto>> cadastrar(@Valid @RequestBody CadastroPJDto cadastroPJDto,
		...
		if(result.hasErrors()) {
			log.error("Validando erros no cadastro do pj {}",result.getAllErrors());
	...
	private void validarDadosExistentes(CadastroPJDto cadastroPJDto, BindingResult result) {
		...
		this.funcionarioService.buscarPorEmail(cadastroPJDto.getEmail()).ifPresent(func -> result.addError(new ObjectError("funcionario", "Email ja cadastrado")));
	}
	/**
